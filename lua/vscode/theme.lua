...
theme.load_syntax = function()
    ...
    hl(0, 'DiffAdd', { fg='NONE', bg=c.vscDiffGreenLight, gui='NONE' })
    hl(0, 'DiffChange', { fg='NONE', bg=c.vscDiffBlueDark, gui='NONE' })
    hl(0, 'DiffDelete', { fg=c.vscDiffRedLight, bg=c.vscDiffRedLight, gui='NONE' })
    hl(0, 'DiffText', { fg=c.vscLeftDark, bg=c.vscDiffRedLight, gui='bold' })
    ...
    -- Bufferline
    hl(0, 'BufferLineFill', { fg='NONE', bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineDuplicate', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='italic' })
    hl(0, 'BufferLineDuplicateSelected', { fg=lualine.insert.a.bg, bg=lualine.normal.a.bg, gui='italic' })
    hl(0, 'BufferLineTab', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineTabSelected', { bg=lualine.normal.a.bg, gui='NONE' })
    hl(0, 'BufferLineTabClose', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineCloseButton', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineCloseButtonSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, gui='NONE' })
    hl(0, 'BufferLineBufferSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, gui='bold,italic' })
    hl(0, 'BufferLineBackground', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineBuffer', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineModified', { bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineModifiedSelected', { bg=lualine.normal.a.bg, gui='NONE' })
    hl(0, 'BufferLineSeparator', { fg=lualine.normal.b.bg, bg=lualine.normal.b.bg, gui='NONE' })
    hl(0, 'BufferLineSeparatorSelected', { fg=lualine.normal.b.bg, bg=lualine.normal.a.bg, gui='NONE' })
    hl(0, 'BufferLineIndicatorSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, gui='NONE' })
