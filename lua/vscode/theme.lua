...
local lualine = require('lualine.themes.vscode')
local theme = {}
...
theme.load_syntax = function()
    ...
    local syntax = {
        ...
        DiffChange = { nil, c.vscDiffBlueDark, 'none', nil },
        DiffDelete = { c.vscDiffRedLight, c.vscDiffRedLight, 'none', nil },
        DiffText = { c.vscLeftDark, c.vscDiffBlueLight, 'bold', nil },
        ...
        BufferLineTabClose = { lualine.normal.b.fg, lualine.normal.b.bg, 'none', nil },
        ...
        BufferLineBufferSelected = { lualine.normal.a.fg, lualine.normal.a.bg, 'bold,italic', nil },
        ...
        BufferLineSeparator = { lualine.normal.b.bg, lualine.normal.b.bg, 'none', nil },
        BufferLineSeparatorSelected = { lualine.normal.b.bg, lualine.normal.a.bg, 'none', nil },
        BufferLineIndicatorSelected = { lualine.normal.a.fg, lualine.normal.a.bg, 'none', nil },
