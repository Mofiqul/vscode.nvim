...
theme.load_syntax = function()
    local c = require('vscode.colors').generate()
    ...
    hl(0, 'DiffAdd', { fg='NONE', bg=c.vscDiffGreenLight, bold=false, underline=false, italic=false })
    hl(0, 'DiffChange', { fg='NONE', bg=c.vscDiffBlueDark, bold=false, underline=false, italic=false })
    hl(0, 'DiffDelete', { fg=c.vscDiffRedLight, bg=c.vscDiffRedLight, bold=false, underline=false, italic=false })
    hl(0, 'DiffText', { fg=c.vscLeftDark, bg=c.vscDiffBlueLight, bold=true, underline=false, italic=false })
    ...
    hl(0, 'Comment', { fg=c.vscGreen, bg='NONE', italic=isItalic })
    ...
    hl(0, 'NvimTreeNormal', { fg=c.vscFront, bg=no_nvimtree_bg and c.vscBack or c.vscLeftDark })
    hl(0, 'NvimTreeCursorLine', { fg='NONE', bg=no_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftMid })
    hl(0, 'NvimTreeVertSplit', { fg=no_nvimtree_bg and c.vscSplitDark or c.vscBack, bg=c.vscBack })
    hl(0, 'NvimTreeEndOfBuffer', { fg=no_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftDark })
    hl(0, 'NvimTreeOpenedFolderName', { fg='NONE', bg=no_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftDark })

    -- Bufferline
    hl(0, 'BufferLineFill', { fg='NONE', bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineDuplicate', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=true })
    hl(0, 'BufferLineDuplicateSelected', { fg=lualine.insert.a.bg, bg=lualine.normal.a.bg, bold=false, underline=false, italic=true })
    hl(0, 'BufferLineTab', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineTabSelected', { bg=lualine.normal.a.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineTabClose', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineCloseButton', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineCloseButtonSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineBufferSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, bold=true, underline=false, italic=true })
    hl(0, 'BufferLineBackground', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineBuffer', { fg=lualine.normal.b.fg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineModified', { bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineModifiedSelected', { bg=lualine.normal.a.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineSeparator', { fg=lualine.normal.b.bg, bg=lualine.normal.b.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineSeparatorSelected', { fg=lualine.normal.b.bg, bg=lualine.normal.a.bg, bold=false, underline=false, italic=false })
    hl(0, 'BufferLineIndicatorSelected', { fg=lualine.normal.a.fg, bg=lualine.normal.a.bg, bold=false, underline=false, italic=false })
