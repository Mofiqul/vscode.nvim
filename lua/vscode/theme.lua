...
theme.set_highlights = function(opts)
    ...
    hl(0, 'String', { fg = (isDark and c.vscOrange or c.vscLightRed), bg = 'NONE' })
    hl(0, 'Character', { fg = (isDark and c.vscOrange or c.vscLightRed), bg = 'NONE' })
    ...
    -- Treesitter
    hl(0, '@character.printf', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@character.special', { fg = c.vscLightBlue, bg = 'NONE' })
    ...
    hl(0, '@string.regexp', { fg = (isDark and c.vscOrange or c.vscLightRed), bg = 'NONE' })
    hl(0, '@string', { fg = (isDark and c.vscOrange or c.vscLightRed), bg = 'NONE' })
    hl(0, '@character', { fg = (isDark and c.vscOrange or c.vscLightRed), bg = 'NONE' })
    hl(0, '@number', { fg = c.vscLightGreen, bg = 'NONE' })
    ...
    hl(0, '@string.escape', { fg = c.vscYellowOrange, bold = true })
