...
highlight("NvimTreeNormal ", c.cdLightBlue, nil, 'none', nil)
...
-- Bufferline
highlight("BufferLineIndicatorSelected", c.cdBlue , nil, 'none', nil)
highlight("BufferLineFill", nil , c.cdCursorDarkDark, 'none', nil)
